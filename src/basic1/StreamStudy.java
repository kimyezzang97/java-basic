...
public class StreamStudy {
    public static void main(String[] args) {
        ...
        //stream2.forEach(System.out::println); // Stream은 1회성? 이어서 밑에 출력하려고 주석
        stream2.forEach(num -> System.out.println("num = " + num)); // 양식에 맞게 변경
        ...
        Stream streamGenerate = Stream.generate( () -> "abc" ).limit(3); // "abc" 3번 반복
        ...
        IntStream intStream = IntStream.range(1, 5); // 1~4 까지 출력
        ...
        intStreamSort.forEach(System.out::print);
        System.out.println();
        ...
        // 3-3. reduce
        System.out.println("== reduce =="); // 연속적으로 합
